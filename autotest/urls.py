...
urlpatterns = [
  ...
  #  path('test/', views.test),
    ...
    path('task_cmdtest/', views.task_cmdtest,name='task_cmdtest'),
    ...
    path('cmdcase_manage/', cmdviews.cmdcase_manage),
    path('cmdcasestep_manage/', cmdviews.cmdcasestep_manage,name='cmdcasestep_manage'),
    path('cmdsearch/', cmdviews.cmdsearch),
    path('cmdstepsearch/', cmdviews.cmdstepsearch),
    path('cmdtest_report/', cmdviews.cmdtest_report),
